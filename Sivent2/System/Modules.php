   ...
   (
      ...
      "ItemsNamer" => "Author",
      "ItemsNamer_UK" => "Author",
      "SqlAccessor" => "SubmissionsObj",
      "SqlClass" => "Submissions",
      "SqlDerivedData" => array("Name","Title","Author"),
      "SqlFile" => "Submissions.php",
      "SqlFilter" => "#Author: #Title",
      "SqlHref" => "1",
   ...
   "Types" => array
   (
      "ItemName" => "Tipo de Inscrição",
      "ItemName_ES" => "Tipo de Inscrión",
      "ItemName_UK" => "Inscription Type",
      "ItemsName" => "Tipos de Inscrição",
      "ItemsName_ES" => "Tipos de Inscrión",
      "ItemsName_UK" => "Inscription Types",
      "ItemsNamer" => "Name",
      "ItemsNamer_ES" => "Name",
      "ItemsNamer_UK" => "Name",
      "SqlAccessor" => "TypesObj",
      "SqlClass" => "Types",
      "SqlDerivedData" => array("Name"),
      "SqlFile" => "Types.php",
      "SqlFilter" => "#Name",
      "SqlHref" => "1",
      "SqlObject" => "TypesObject",
      "SqlTable" => "#Unit__#Event_Types",
   ),
   "Lots" => array
   (
      "ItemName" => "Lote",
      ...
      "ItemsName_UK" => "Lots",
      "ItemNamer" => "LimitDate",
      "ItemsNamer" => "LimitDate",
      "ItemsNamer_ES" => "LimitDate",
      "ItemsNamer_UK" => "LimitDate",
      "SqlAccessor" => "LotsObj",
      "SqlClass" => "Lots",
      "SqlDerivedData" => array("LimitDate"),
      "SqlFile" => "Lots.php",
      "SqlFilter" => "#LimitDate",
      "SqlHref" => "1",
      "SqlObject" => "LotsObject",
      "SqlTable" => "#Unit__#Event_Lots",
   ),
